...
/**
 * @fileOverview Provides AI-powered tag suggestions for blog posts.
 *
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a blog post tagging expert. Given the content of a blog post, you will suggest relevant tags.

Blog Post Content: {{{postContent}}}

Suggest at least 3 tags that are relevant to the content.`,
});
